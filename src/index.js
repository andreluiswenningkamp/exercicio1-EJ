...
function obterTelefone() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) {
                    rl.question('Qual é o seu número de telefone? ', function (telefone) {
                        resolve(telefone);
                    });
                })];
        });
...
function adicionar_contato() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, obterNome()];
                case 1:
                    nome = _a.sent();
                    return [4 /*yield*/, obterTelefone()];
                case 2:
                    telefone = _a.sent();
...
while (escolha == '0') {
    ...
    var map = new Map();
    for (var _i = 0, _a = Object.values(contatos); _i < _a.length; _i++) {
        var value = _a[_i];
